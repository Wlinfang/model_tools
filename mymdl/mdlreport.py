...
class ModelReport:
    ...
    def report_liftchart(self, df_train, df_test, x, y, n_bin=10,
        ...
        if plot_trte:
            ...
            t = df_test[cols]
        fig, gp = plotutil.plot_score_liftvar(t, x, y, group_cols, feature_grid=feature_grid, is_show=is_show)
        if is_save:
    ...
    def report_feature(self, df_train, df_test, feature_name, y_true, y_pred, group_cols=[], n_bin=10, plot_trte=True,
        ...
        fig, gp = plotutil.plot_univar_and_pdp(t, x=feature_name, y_true=y_true, y_pred=y_pred, group_cols=group_cols,
